...
public class TestHelloIdentity extends TestCase {
	...
	private MessagingName helloIdentDelSvc = new MessagingName(SYSNAME, "hello_identity_delegate");
	...
	public TestHelloIdentity(String name) {
		super(name);
	}
	...
	public void testHelloUserDelegateRequest() {
        ...
        String ooid = (String)msgin1.getContent();
        ...
        content.put("data", "some data");

        long currentTimeLong = System.currentTimeMillis()/1000 + 30;
        String expiry = String.valueOf(currentTimeLong);
        
        // Create and send request message
        IonMessage msgin3 = baseProcess.rpcSend(helloIdentDelSvc, "hello_user_request_delegate", content, ooid, expiry);
        assertFalse(msgin1.isErrorMessage());
        String rcvdContentStr = (String)msgin3.getContent();
        String compareStr = "{'value': 'Hello there " + ooid + "'}";
        assertTrue(rcvdContentStr.equals(compareStr));
        baseProcess.ackMessage(msgin1);
    }
