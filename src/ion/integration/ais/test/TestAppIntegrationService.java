...
//        assertTrue(replyJsonString.startsWith("{\"ooi_id\":"));
	...
	// Sample input string: "{\"user_ooi_id\": \"3f27a744-2c3e-4d2a-a98c-050b246334a3\",\"minLatitude\": 1.1,\"maxLatitude\": 2.2,\"minLongitude\": 3.3,\"maxLongitude\": 4.4,\"minDepth\": 5.5,\"maxDepth\": 6.6,\"minTime\": 7.7,\"maxTime\": 8.8}"
	// Sample output string: "{\"data_resource_id": [\"id1\", \"id2\"]}"
