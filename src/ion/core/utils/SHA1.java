...
public abstract class SHA1 {
	...
	public String getSHA1HashString() {
		return SHA1.getSHA1HashString(getBytes());
	}
	 ...
	 */
	public static String getSHA1HashString(String s) {
		return getSHA1HashString(s.getBytes());
	}
	 ...
	 * @return the SHA1 hash
	 */
	public static String getSHA1HashString(int n) {
		return getSHA1HashString(getBytes32Bit(n));
	}
	 ...
	 * @return the SHA1 hash
	 */
	public static String getSHA1HashString(long n) {
		return getSHA1HashString(getBytes64Bit(n));
	}
	 ...
	 * @return the SHA1 hash
	 */
	public static String getSHA1HashString(float n) {
		return getSHA1HashString(getBytes32BitFloat(n));
	}
	 ...
	 * @return the SHA1 hash
	 */
	public static String getSHA1HashString(double n) {
		return getSHA1HashString(getBytes64BitFloat(n));
	}
	 ...
	 * @return the SHA1 hash
	 */
	public static String getSHA1HashString(char n) {
		return getSHA1HashString(getBytes32Bit(n));
	}
	 ...
	 * @return the SHA1 hash
	 */
	public static String getSHA1HashString(short n) {
		return getSHA1HashString(getBytes32Bit(n));
	}
	 ...
	 * @return the SHA1 hash
	 */
	public static String getSHA1HashString(byte n) {
		return getSHA1HashString(new byte[] { n });
	}


    public static String getSHA1HashString(byte[] bytes) {
        return bytesToHex(getSHA1Hash(bytes));
    }
	 ...
	 * @return the SHA1 hash
	 */
	public static byte[] getSHA1Hash(int n) {
	 ...
	 * @return the SHA1 hash
	 */
	public static byte[] getSHA1Hash(long n) {
	 ...
	 * @return the SHA1 hash
	 */
	public static byte[] getSHA1Hash(float n) {
	 ...
	 * @return the SHA1 hash
	 */
	public static byte[] getSHA1Hash(double n) {
	 ...
	 * @return the SHA1 hash
	 */
	public static byte[] getSHA1Hash(char n) {
		return getSHA1Hash(getBytes32Bit(n));
	}
	 ...
	 * @return the SHA1 hash
	 */
	public static byte[] getSHA1Hash(short n) {
		return getSHA1Hash(getBytes32Bit(n));
	}
	 ...
	 * @return the SHA1 hash
	 */
	public static byte[] getSHA1Hash(byte n) {
